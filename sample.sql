...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=4166062054ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=20kt&table=reg">`20kt`.`reg`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=dummy_db&table=reg">`dummy_db`.`reg`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=feedback&table=factulty">`feedback`.`factulty`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=sample&table=faculty_details">`sample`.`faculty_details`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=sample&table=reg">`sample`.`reg`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=sample&table=login">`sample`.`login`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=sample&table=student_details">`sample`.`student_details`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=feedback&table=defaultcsm">`feedback`.`defaultcsm`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=sample&table=student_details_1">`sample`.`student_details_1`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=feedback&table=DefaultCSM">`feedback`.`DefaultCSM`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="56377c4473636b442f7e47254534627c">
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="dummy_db" targettable="reg">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `reg`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="20kt" targettable="reg">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">DELETE FROM `reg` WHERE `reg`.`rno` = &#039;drtyrtuy&#039;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="20kt" targettable="reg">
                            <div class="action_content">
